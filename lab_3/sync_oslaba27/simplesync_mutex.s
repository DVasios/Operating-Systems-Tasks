...
.LC1:
	.string	"pthread_mutex_lock failed"
.LC2:
	.string	"pthread_mutex_unlock failed"
.LC3:
...
.L5:
	.loc 1 52 0
	movl	$mutex1, %edi 		; This is where the pthread_mutex_lock is
...
.L3:
	...
	movl	%edx, (%rax)
	.loc 1 58 0
	movl	$mutex1, %edi		; This is where the pthread_mutex_unlock is
...
.L11:
	.loc 1 81 0
	movl	$mutex1, %edi
	call	pthread_mutex_lock ; This is where the pthread_mutex_lock is
	testl	%eax, %eax
	je	.L9
	.loc 1 82 0	
	movl	$.LC1, %edi
...
.L9:
	...
	.loc 1 87 0
	movl	$mutex1, %edi 	 
	call	pthread_mutex_unlock ; This is where the pthread_mutex_unlock is
	testl	%eax, %eax
	je	.L10
	.loc 1 88 0
	movl	$.LC2, %edi
...
.LASF47:
	.string	"pthread_t"
.LASF75:
	.string	"/home/oslab/oslaba27/jim/lab_3/sync"
.LASF76:
	.string	"_IO_lock_t"
